...
<form class="form-inline md-form form-sm mt-0">
  ...
  <input class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Search" style="border-color:#959595;background-color:rgb(40,40,40);"
	...
	<li class="hi" id="l4"><a href="post_upload.php"><img src="post1.png" height="25px" width="25px"></a></li>
...
?>
		...
		echo'<div class="container" style="width:500px;margin-left:300px;">  
		<table  >';
			  ...
			  border-radius:15px; color:rgb(100,100,100);margin-right:460px; background-color:rgb(20,20,20);padding-left:1px;"> 
							 ...
							 echo 
							  ...
							  <input hidden name="photo" value="'.$row['photo'].'"> 
								 <input type="text" name="com" id="com" onkeyup="myFunction()" size="50%" placeholder="Enter comment......." style="border:none; border-radius:10px; background-color:black; padding:10px;">
